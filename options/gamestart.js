...
maps = { 
    ...
    [
        new Map(
            ...
            [{x: 7, y: 9, income: 10}, {x: 7, y: 11, income: 10}, 
                {x: 13, y: 9, income: 10}, {x: 13, y: 11, income: 10},
                {x: 17, y: 17, income: 20}, {x: 3, y: 17, income: 20},
                {x: 0, y: 0, income: 10}, {x: 20, y: 0, income: 10},
                {x: 20, y: 0, income: 10}, {x: 20, y: 0, income: 10},
                {x: 5, y: 2, income: 10}, {x: 15, y: 2, income: 10}],
            [{x: 7, y: 10}, {x: 8, y: 10}, {x: 8, y: 11},
             {x: 12, y: 10}, {x: 12, y: 11}, {x: 13, y: 10}],
            [{x: 10, y: 10}, {x: 10, y: 11}]
        ),
        new Map(
            {x: 30, y: 23},
