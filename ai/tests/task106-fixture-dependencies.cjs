...
console.log('DEPENDENCY CONTROL: real vectorizeContent/mutableVectorGrid, native Grid/Cell/Hexagon/Empty; unchanged 75-case scenario matrix and assertions');
