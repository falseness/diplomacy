...
function registerDemonVariant(UnitClass, type, asset) {
    ...
    for (const [stat, key] of [['maxHP', 'health'], ['dmg', 'damage'], ['speed', 'movement']])
        Object.defineProperty(UnitClass, stat, {get() { return currentDemonTypes()[type][key] }})
    if (asset === 'archer')
        Object.defineProperty(UnitClass, 'range', {get() { return currentDemonTypes()[type].range }})
